...
(function() {
    ...
    var q2 = new Question('Course author name is:', ['John', 'Mike', 'Johnas'], 2);
    var q3 =new Question('How\'s your coding?', ['Boring', 'Fun', 'Hard'], 1);
...
(function() {
    ...
    function nextQuestion() {
        ...
        var answer = prompt('Please select a correct answer');
        if(answer !== 'exit') {
